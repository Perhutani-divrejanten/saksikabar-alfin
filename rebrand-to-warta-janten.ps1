# Rebrand dari Indonesia Daily ke Janten Bersuara
...
Write-Log -Message "===== REBRAND Janten Bersuara DIMULAI ====="
...
foreach ($file in $htmlFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = "Indonesia Daily"; New = "Janten Bersuara" },
            @{ Old = "IndonesiaDaily"; New = "jantenbersuara" },
            @{ Old = "indonesiadaily"; New = "jantenbersuara" },
            # Social media links
            @{ Old = "https://twitter.com/indonesiadaily"; New = "https://twitter.com/jantenbersuara" },
            @{ Old = "https://facebook.com/indonesiadaily"; New = "https://facebook.com/jantenbersuara" },
            @{ Old = "https://instagram.com/indonesiadaily"; New = "https://instagram.com/jantenbersuara" },
            @{ Old = "https://youtube.com/@indonesiadaily"; New = "https://youtube.com/@jantenbersuara" },
            @{ Old = "https://linkedin.com/company/indonesiadaily"; New = "https://linkedin.com/company/jantenbersuara" },
            # Email
            @{ Old = "indonesiadaily@gmail.com"; New = "jantenbersuara@gmail.com" },
            # Logo references
            @{ Old = 'alt="IndonesiaDaily"'; New = 'alt="jantenbersuara"' }
        )
...
foreach ($file in $packageJsonFiles) {
    try {
        ...
        $replacements = @(
            @{ Old = """name"": ""indonesiadaily"""; New = """name"": ""jantenbersuara""" },
            @{ Old = """name"": ""indonesiadaily-article-generator"""; New = """name"": ""jantenbersuara-article-generator""" }
        )
...
Write-Log -Message ""
Write-Log -Message "Rebrand Janten Bersuara selesai ✅"

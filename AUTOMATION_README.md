...
- **email**: Email portal (akan replace "jantenbersuara33@gmail.com")
- **socialHandle**: Handle social media (akan replace "jantenbersuara")
- **colors**: Tema warna
...
| `jantenbersuara` | `siteName` (tanpa spaces) |
| `jantenbersuara` | `socialHandle` |
| `jantenbersuara33@gmail.com` | `email` |
